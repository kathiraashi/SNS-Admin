   ...
   exports.Department_Create = function(req, res) {
      ...
      if(!ReceivingData.Department || ReceivingData.Department === '' ) {
         ...
         Create_Department.save(function(err, result) { // Department Save Query
            if(err) {
               ErrorManagement.ErrorHandling.ErrorLogCreation(req, 'Settings Department Creation Query Error', 'Department.controller.js');
   ...
   exports.Department_Update = function(req, res) {
      ...
      if(!ReceivingData.Department_Id || ReceivingData.Department_Id === '' ) {
         ...
         DepartmentModel.DepartmentSchema.findOne({'_id': ReceivingData.Department_Id}, {}, {}, function(err, result) { // Department FindOne Query
            if(err) {
               ErrorManagement.ErrorHandling.ErrorLogCreation(req, 'Settings Department FindOne Query Error', 'Department.controller.js', err);
               ...
               if (result !== null) {
                  ...
                  result.save(function(err_1, result_1) { // Department Update Query
                     if(err_1) {
                        ErrorManagement.ErrorHandling.ErrorLogCreation(req, 'Settings Department Update Query Error', 'Department.controller.js');
            ...
            if(err) {
               ...
               if (result !== null) {
                  ...
                  result.save(function(err_1, result_1) { // Department Delete Query
                     if(err_1) {
                        ErrorManagement.ErrorHandling.ErrorLogCreation(req, 'Settings Department Delete Query Error', 'Department.controller.js');
