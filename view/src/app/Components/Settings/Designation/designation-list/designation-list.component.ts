...
export class DesignationListComponent implements OnInit {
   ...
   CreateScheduleActivity() {
      ...
      this.bsModalRef = this.modalService.show(ModelDesignationCreateComponent, Object.assign({initialState}, {ignoreBackdropClick: true, class: '' }));
   ...
   ViewScheduleActivity(_index) {
      ...
      this.bsModalRef = this.modalService.show(ModelDesignationCreateComponent, Object.assign({initialState}, { class: '' }));
   }
   // Delete Machine Type
   DeleteScheduleActivity(_index) {
      const initialState = { Text: ' Designation ' };
